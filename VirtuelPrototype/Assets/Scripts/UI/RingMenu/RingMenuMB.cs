...
public class RingMenuMB : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < Data.Elements.Length; i++)
        {
            ...
            //set icon
            Pieces[i].Icon.transform.localPosition = Pieces[i].CakePiece.transform.localPosition + Quaternion.AngleAxis((i - 1) * stepLength, Vector3.forward) * Vector3.up * iconDist;
